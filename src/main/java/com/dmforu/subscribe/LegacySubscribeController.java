...
public class LegacySubscribeController {
    ...
    public void createTokenDepartment(@RequestBody InitRequestDto initRequestDto) {
        ...
        boolean departmentOnOff = initRequestDto.getDepartment() != null;
        boolean keywordOnOff = initRequestDto.getTopic() != null;

        tokenService.createInitTokenInformation(
                new InitTokensDTO(initRequestDto.getToken(), initRequestDto.getDepartment(), initRequestDto.getTopic(), departmentOnOff, keywordOnOff)
        );
    }
    ...
    public void updateDepartment(@RequestBody DepartmentRequestDto departmentDto) {
        ...
        DepartmentStatusDTO statusDTO = new DepartmentStatusDTO();
        statusDTO.setToken(departmentDto.getToken());
        statusDTO.setDepartmentOnOFF(true);

        departmentService.updateDepartmentStatus(statusDTO);
    }
    ...
    public void deleteDepartment(@RequestBody TokenRequestDto tokenRequestDto) {
        ...
        dto.setToken(tokenRequestDto.getToken());
        dto.setDepartmentOnOFF(false);

        departmentService.updateDepartmentStatus(dto);
    }
    ...
    public void updateTopic(@RequestBody TopicRequestDto tokensDto) {
        tokenService.updateKeyword(
                new KeywordDTO(tokensDto.getToken(), tokensDto.getTopics())
        );

        KeywordStatusDTO statusDto = new KeywordStatusDTO();
        statusDto.setToken(tokensDto.getToken());
        statusDto.setKeywordOnOFF(true);

        tokenService.updateKeywordStatus(statusDto);
    }
    ...
    public void deleteTopic(@RequestBody TokenRequestDto tokensDto) {
        ...
        dto.setToken(tokensDto.getToken());
        dto.setKeywordOnOFF(false);

        tokenService.updateKeywordStatus(dto);
    }
