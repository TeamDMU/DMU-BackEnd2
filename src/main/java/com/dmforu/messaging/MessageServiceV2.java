...
public class MessageServiceV2 {
    ...
    private void departmentMessage(NoticeDtoV2 noticeDtoV2) {
    ...
    //학과 메시지 작성
    private void buildMessaging(NoticeDtoV2 noticeDtoV2, List<String> tokenList) {
...
//        FirebaseMessaging.getInstance().send(message);
    ...
    //대학 메시지 작성
    private void buildMessaging(NoticeDtoV2 noticeDtoV2, List<String> tokenList, String keyWord) {
